	...
	public function index()
	{
        ...
        public function edit_preview($id_preview)
        {
                ...
                if ($this->form_validation->run() == FALSE)
                {
                        ...
                        'preview' => $preview,
                        'isi' => 'masteradmin/home/edit_preview');
                ...
                else
                {
                        ...
                        redirect(base_url('masteradmin/home'),'refresh');
        ...
        public function edit_visi($id_visi)
        {
                ...
                if ($this->form_validation->run() == FALSE)
                {
                        ...
                        'visi' => $visi,
                        'isi' => 'masteradmin/home/edit_visi');
        ...
        public function edit_misi($id_misi)
        {
                ...
                if ($this->form_validation->run() == FALSE)
                {
                        ...
                        'misi' => $misi,
                        'isi' => 'masteradmin/home/edit_misi');
