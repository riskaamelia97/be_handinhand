    ...
    <?php 
            ...
            foreach ( $preview as $preview) 
            {
                ...
                <tr>
                    ...
                    <td>
                    <div class="btn-group">
                    <a href="<?php echo base_url('admin/home/edit_preview/'.$preview->id_preview)?>" class="btn btn-success">
    ...
    <?php 
            ...
            foreach ( $visi as $data) 
            {
                ...
                <tr>
                    ...
                    <div class="btn-group">
                    <a href="<?php echo base_url('admin/home/edit_visi/'.$data->id_visi)?>" class="btn btn-success">
                    <i class="fa fa-edit"></i> Edit</a>
    ...
    <?php 
            ...
            foreach ( $misi as $data) 
            {
                ...
                <tr>
                    ...
                    <div class="btn-group">
                    <a href="<?php echo base_url('admin/home/edit_misi/'.$data->id_misi)?>" class="btn btn-success">
                    <i class="fa fa-edit"></i> Edit</a>
