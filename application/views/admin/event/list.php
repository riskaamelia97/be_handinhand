...
<table  class="table table-bordered"  id="example1">
            ...
            foreach ( $event as $data) 
            {
                ...
                <tr>
                  ...
                  <td>
                   ...
                   <div class="btn">
                    <a href="<?php echo base_url('admin/event/edit_event/'.$data->id_event)?>" class="btn btn-success">
                    <i class="fa fa-edit"></i> Edit</a>
                    </div> 

                    <a href="<?php echo base_url('admin/event/delete_event/'.$data->id_event)?>" class="btn btn-warning">
  ...
  <br><br>
  <p><a href="<?php echo base_url('admin/event/tambah_event') ?>" class="btn bg-red btn-flat">
