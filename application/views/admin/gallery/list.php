...
<div class="table-responsive">                         
    ...
    <?php 
            ...
            foreach ( $gallery as $data) 
            {
                ...
                <tr>
                  ...
                  <td>
                  <a href="<?php echo base_url('admin/gallery/delete_foto/'.$data->id_galeri)?>" class="btn btn-warning">
  ...
  <br><br>
  <p><a href="<?php echo base_url('admin/gallery/tambah_foto') ?>" class="btn bg-red btn-flat">
...
<div class="table-responsive">          
  ...
  <br><br>
  <p><a href="<?php echo base_url('admin/gallery/tambah_video') ?>" class="btn bg-red btn-flat">
