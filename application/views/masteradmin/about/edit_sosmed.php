...
//open form
echo form_open_multipart(base_url('masteradmin/about/edit_sosmed/'.$sosmed->id_sosmed));
?>
<div class="box box-danger">
<div class="box-body ">
    <div class="form-group">
    <label>Logo Social Media</label>
    <input type="file" id="logo_sosmed" name="logo_sosmed" class="form-control" required>
    </div>
    ...
    $sosmed->jenis_sosmed?>" required>
    </div>

    <div class="form-group">
    <label>Link Social Media</label>
    <input type="text" name="link_sosmed" class="form-control" placeholder="Link Social Media" value="<?php echo
    $sosmed->link_sosmed?>" required>
    </div>
